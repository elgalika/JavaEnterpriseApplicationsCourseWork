...
INSERT INTO person (name, email, mobile_number, pwd, role_id, created_at, created_by)
VALUES ('Elga', 'elga5@gmail.com', '9876543210', '12345678', 
...
VALUES ((SELECT person_id FROM person WHERE email = 'elga5@gmail.com'), 6);
...
SET lecturer_id = (
    ...
    WHERE email = 'elga5@gmail.com'
)
WHERE course_id = (
    SELECT course_id FROM (
        SELECT course_id FROM courses WHERE name = 'New Course'
    ) AS subquery
);
...
INSERT INTO person_courses (person_id, course_id)
VALUES ((SELECT person_id FROM person WHERE email = 'elga5@gmail.com'), 7);
